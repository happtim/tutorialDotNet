...
namespace SampleNetty
{
  ...
  */
    ...
    public class MyLengthFieldBasedFrameDecoder : ByteToMessageDecoder
    {
        ...
        /// </param>
        public MyLengthFieldBasedFrameDecoder(int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip, bool failFast)
        ...
        ///     Defaults to <c>true</c> in other overloads.
        /// </param>
        public MyLengthFieldBasedFrameDecoder(ByteOrder byteOrder, int maxFrameLength, int lengthFieldOffset, int lengthFieldLength, int lengthAdjustment, int initialBytesToStrip, bool failFast)
        {
            if (maxFrameLength <= 0)
            {
