...
namespace Algorithm.Graph
{
    ...
    public abstract class Graph<V, E>
    {
         ...
         * @see #getEdgeFactory()
         */
        public abstract bool addEdge(V sourceVertex, V targetVertex, E e);
         ...
         */
        public abstract bool containsEdge(V sourceVertex, V targetVertex);
         ...
         * @return <tt>true</tt> if this graph contains the specified edge.
         */
        public abstract bool containsEdge(E e);
         ...
         */
        public abstract bool removeAllEdges(IEnumerable<E> edges);
         ...
         */
        public abstract HashSet<E> removeAllEdges(V sourceVertex, V targetVertex);
         ...
         */
        public abstract bool removeAllVertices(IEnumerable<V> vertices);
         ...
         */
        public static double DEFAULT_EDGE_WEIGHT { get; set; } = 1.0;
